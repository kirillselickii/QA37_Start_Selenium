...
//by tag name
      ...
      WebElement btn10 = wd.findElement(By.xpath("//h1"));
      ...
      List <WebElement> list6 = wd.findElements(By.xpath("//a"));
...
//by class
      ...
      //WebElement bc10 = wd.findElement(By.xpath("//*[@class='navbar-component_nav__1X_4m']"));
      WebElement bc6 = wd.findElement(By.className("active"));
      WebElement bc7 = wd.findElement(By.cssSelector(".active"));
      WebElement bc11 = wd.findElement(By.xpath("//*[@class='active']"));
      ...
      WebElement bc12 = wd.findElement(By.xpath("//*[@class='login_login__3EHKB']"));
//By ID
      WebElement bid1 = wd.findElement(By.id("root"));
      WebElement bid2 = wd.findElement(By.cssSelector("#root"));
      WebElement bid3 = wd.findElement(By.xpath("//*[@id='root']"));
// by atribute
      WebElement ba1 = wd.findElement(By.cssSelector("[id='root']"));
      WebElement ba7 = wd.findElement(By.xpath("//*[@id='root']"));
      WebElement ba2 = wd.findElement(By.cssSelector("[class='container']"));
      WebElement ba8 = wd.findElement(By.xpath("//*[@class='container']"));
      //WebElement ba3 = wd.findElement(By.cssSelector("[class='navbar-component_nav__1X_4mr']"));
      //WebElement ba9 = wd.findElement(By.xpath("//*[@class='navbar-component_nav__1X_4mr']"));
      ...
      WebElement ba10 = wd.findElement(By.xpath("//*[@placeholder='Email']"));
      WebElement ba6 = wd.findElement(By.cssSelector("[placeholder=\"Password\"]"));
      WebElement ba25 = wd.findElement(By.cssSelector("[placeholder='Password']"));
      WebElement ba11 = wd.findElement(By.xpath("//*[@placeholder='Password']"));

      WebElement ba12 = wd.findElement(By.cssSelector("[href='/home']"));
      WebElement ba20 = wd.findElement(By.xpath("//*[@href='/home']"));
      WebElement ba13 = wd.findElement(By.cssSelector("[href='/about']"));
      WebElement ba21 = wd.findElement(By.xpath("//*[@href='/about']"));
      WebElement ba14 = wd.findElement(By.cssSelector("[href='/login']"));
      WebElement ba22 = wd.findElement(By.xpath("//*[@href='/login']"));
      WebElement ba15 = wd.findElement(By.cssSelector("[name='email']"));
      WebElement ba23 = wd.findElement(By.xpath("//*[@name='email']"));
      WebElement ba16 = wd.findElement(By.cssSelector("[name='password']"));
      WebElement ba24 = wd.findElement(By.xpath("//*[@name='password']"));

        //start from ...
      wd.findElement(By.cssSelector("[placeholder ^='Pas']"));
      WebElement ba18 = wd.findElement(By.xpath("//input[starts-with(@placeholder, 'Em')]"));
        //end on ...
      wd.findElement(By.cssSelector("[placeholder $='ord']"));
        //contains
      wd.findElement(By.cssSelector("[placeholder *='ssw']"));
      WebElement ba19 = wd.findElement(By.xpath("//input[contains(@placeholder, 'ssw')]"));
    }
    }
