...
public class IndexHtmlClass {
    WebDriver wd;

    @BeforeClass
    public void setUp() {
        wd = new ChromeDriver();
        wd.get("file:///D:/DownloadsD/index.html");
    }
    ...
    public void cssLocators() {
        ...
        WebElement inputEmail1 = wd.findElement(By.cssSelector("[class='container']"));
        WebElement inputEmail2 = wd.findElement(By.cssSelector("[placeholder=\"Type your name\"]"));
        WebElement inputEmail3 = wd.findElement(By.cssSelector("[placeholder='Type your name']"));
        ...
        //By.linkText By.partialinklText - not use
        WebElement a = wd.findElement(By.linkText("Item 1"));
        List <WebElement> a3 = wd.findElements(By.partialLinkText("m 1"));
